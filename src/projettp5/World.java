...
public class World {
    ...
    public World(int taille, int nbP) {
        ...
        while (test) {
            ...
            if (choixJoueur == 2) {
                ...
                Joueur joueurcompt = new Joueur(compt);
        ...
        for (int i = 0; i < (nbP / 6); i++) {
            ...
            Archer Archeri = new Archer("Archer " + i, 100, 0, 80, 50, 0, 0, 20, 0, 5, 10, origine, 30);
        ...
        for (int k = 0; k < (nbP / 6); k++) {
            ...
            Guerrier Guerrierk = new Guerrier("Guerrier " + k, 100, 0, 80, 50, 0, 0, 20, 0, 1, 50, origine);
            boolean test2;
            test2 = true;
            while (test2) {
                int nouvx = generePos.nextInt(taille);
        ...
        for (int m = 0; m < (nbP / 6); m++) {
            ...
            Mage Magem = new Mage("Mage " + m, 10, 10, 10, 10, 70, 10, 10, 10, 10, 10, origine);
            boolean test2;
            test2 = true;
            while (test2) {
                int nouvx = generePos.nextInt(taille);
        ...
        for (int n = 0; n < (nbP / 6); n++) {
            ...
            Paysan Paysann = new Paysan("Paysan " + n, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, origine);
            boolean test2;
            test2 = true;
            while (test2) {
                int nouvx = generePos.nextInt(taille);
        ...
        for (int p = 0; p < (nbP / 6); p++) {
            ...
            Loup Loupp = new Loup("Loup " + p, 10, 10, 10, 10, 40, origine);
            boolean test2;
            test2 = true;
            while (test2) {
                int nouvx = generePos.nextInt(taille);
    ...
    public void tourDeJeu(int nbTour) {
        ...
        for (int i = 1; i <= nbTour; i++) {
            ...
            for (int j = 0; j < lJoueur.size(); j++) {
                System.out.println("====================");
                System.out.println("Au tour de Joueur " + (j + 1));
                boolean test;
                test = true;
                while (test) {
                    System.out.println("Que désirez vous faire?");
            ...
            for (int i1 = 0; i1 < lArcher.size(); i1++) {
                if (lArcher.get(i1).APorter(this)) {
                    ...
                    lArcher.get(i1).deplacerIA(lCreature);
                }
            }
            System.out.println("====================");
            System.out.println("Au tour des IA - Guerriers");
            for (int i2 = 0; i2 < lGuerrier.size(); i2++) {
                if (lGuerrier.get(i2).APorter(this)) {
                    lGuerrier.get(i2).combattreIA(this);
                } else {
                    lGuerrier.get(i2).deplacerIA(lCreature);
                }
            }
            System.out.println("====================");
            System.out.println("Au tour des IA - Mages");
            for (int i3 = 0; i3 < lMage.size(); i3++) {
                if (lMage.get(i3).APorter(this)) {
                    lMage.get(i3).combattreIA(this);
                } else {
                    lMage.get(i3).deplacerIA(lCreature);
                }
            }
            System.out.println("====================");
            System.out.println("Au tour des IA - Loups");
            for (int i4 = 0; i4 < lLoup.size(); i4++) {
                if (lLoup.get(i4).APorter(this)) {
                    lLoup.get(i4).combattreIA(this);
                } else {
                    lLoup.get(i4).deplacerIA(lCreature);
                }
            }
            System.out.println("====================");
            System.out.println("Au tour des IA - Lapins");
            for (int i5 = 0; i5 < lLoup.size(); i5++) {
                    lLapin.get(i5).deplacerIA(lCreature);
                
            }
            System.out.println("====================");
            System.out.println("Au tour des IA - Paysans");
            for (int i6 = 0; i6 < lPaysan.size(); i6++) {
                    lPaysan.get(i6).deplacerIA(lCreature);
